...
> A personal documentation hub for cloud engineering concepts, focused on **Microsoft Azure**. This repository serves as my public knowledge base — covering core cloud principles, Azure services, and detailed notes built up topic by topic.
...
> Note: Click any file name to download and view it. More materials will be added as new topics are covered.
...
- ✅ CapEx vs OpEx & Consumption-based pricing
- ✅ Cloud Benefits (High Availability, Elasticity, Scalability, Reliability, Security, etc.)

**Microsoft Azure**
- ✅ Azure Regions, Availability Zones & Region Pairs
- ✅ Azure Sovereign Regions (US Government & Azure China)
- ✅ Azure Resources, Resource Groups, Subscriptions & Management Groups
- ✅ Azure Compute Services (VMs, Scale Sets, Containers, AKS, Functions, App Services)
...
- ✅ Identity & Security (Microsoft Entra ID, MFA, Authentication vs Authorization)

**Coming Soon**
- 🔄 More Azure services and advanced topics *(to be added as new topics are covered)*

---

##  About This Repository

This is a personal knowledge base for cloud engineering, with a current focus on **Microsoft Azure**. Every topic gets documented here — from foundational concepts to service-level deep dives — building a reference that grows over time.

The goal is to keep everything organized, detailed, and publicly accessible for anyone who finds it useful.
...
All documents in this repository are prepared for **educational purposes**, based on personal research and study notes.
